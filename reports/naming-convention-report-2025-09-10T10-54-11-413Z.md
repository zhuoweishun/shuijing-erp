...
| src\utils\fieldConverter.ts | 175 | `availableQuantity` | sku | camelCase in frontend | `available_quantity` |
| src\utils\fieldConverter.ts | 269 | `customerPhone` | customer | camelCase in frontend | `customer_phone` |
...
| backend\src\utils\fieldConverter.ts | 36 | `updated_at` | time | snake_case in backend | `updatedAt` |
...
| 文件 | 行号 | 字段 | 类别 | 问题 | 建议修复 |
|------|------|------|------|------|----------|
| backend\prisma\schema.prisma | 4 | `generator` | database_field | camelCase in database schema | `generator` |
| backend\prisma\schema.prisma | 8 | `datasource` | database_field | camelCase in database schema | `datasource` |
| backend\prisma\schema.prisma | 16 | `username` | database_field | camelCase in database schema | `username` |
| backend\prisma\schema.prisma | 17 | `email` | database_field | camelCase in database schema | `email` |
| backend\prisma\schema.prisma | 18 | `password` | database_field | camelCase in database schema | `password` |
| backend\prisma\schema.prisma | 19 | `role` | database_field | camelCase in database schema | `role` |
...
| backend\prisma\schema.prisma | 22 | `avatar` | database_field | camelCase in database schema | `avatar` |
| backend\prisma\schema.prisma | 23 | `isActive` | database_field | camelCase in database schema | `is_active` |
| backend\prisma\schema.prisma | 24 | `lastLoginAt` | database_field | camelCase in database schema | `last_login_at` |
...
| backend\prisma\schema.prisma | 31 | `lastEditedPurchases` | database_field | camelCase in database schema | `last_edited_purchases` |
| backend\prisma\schema.prisma | 32 | `editLogs` | database_field | camelCase in database schema | `edit_logs` |
| backend\prisma\schema.prisma | 33 | `createdSkus` | database_field | camelCase in database schema | `created_skus` |
| backend\prisma\schema.prisma | 34 | `skuInventoryLogs` | database_field | camelCase in database schema | `sku_inventory_logs` |
| backend\prisma\schema.prisma | 35 | `financialRecords` | database_field | camelCase in database schema | `financial_records` |
| backend\prisma\schema.prisma | 36 | `customerNotes` | database_field | camelCase in database schema | `customer_notes` |
| backend\prisma\schema.prisma | 37 | `createdMaterials` | database_field | camelCase in database schema | `created_materials` |
| backend\prisma\schema.prisma | 16 | `name` | database_field | camelCase in database schema | `name` |
| backend\prisma\schema.prisma | 52 | `contact` | database_field | camelCase in database schema | `contact` |
| backend\prisma\schema.prisma | 21 | `phone` | database_field | camelCase in database schema | `phone` |
| backend\prisma\schema.prisma | 17 | `email` | database_field | camelCase in database schema | `email` |
...
| backend\prisma\schema.prisma | 153 | `productCode` | database_field | camelCase in database schema | `product_code` |
| backend\prisma\schema.prisma | 16 | `name` | database_field | camelCase in database schema | `name` |
| backend\prisma\schema.prisma | 56 | `description` | database_field | camelCase in database schema | `description` |
...
| backend\prisma\schema.prisma | 206 | `details` | database_field | camelCase in database schema | `details` |
| backend\prisma\schema.prisma | 400 | `ipAddress` | database_field | camelCase in database schema | `ip_address` |
