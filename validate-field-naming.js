 ...
 * 主验证函数
 */
function validate_field_naming() {
  console.log('🔍 开始字段命名验证...');
  console.log('=' .repeat(60));
  
  // 检查前端文件（应使用 snakeCase）
  console.log('📱 检查前端文件...');
  scanDirectory('./src', ['.tsx', '.ts'], 'snakeCase', 'frontend');
...
if (require.main === module) {
  const success = validate_field_naming();
  process.exit(success ? 0 : 1);
}

module.exports = { validate_field_naming };