...
// 上传采购图片
router.post('/purchase-images', authenticateToken, upload.array('images', 5), asyncHandler(async (req, res) => {
...
// 删除图片
router.delete('/purchase-images', authenticateToken, asyncHandler(async (req, res) => {
  // 验证请求数据
