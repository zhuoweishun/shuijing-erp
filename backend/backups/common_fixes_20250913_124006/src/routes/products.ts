...
router.get('/materials', authenticateToken, asyncHandler(async (_req, res) => {
...
router.get('/:id', authenticateToken, asyncHandler(async (req, res) => {
  ...
  const converted = {
    ...
    created_at: product.created_at,
    updated_at: product.updated_at,
    material_usages: product.materialUsages?.map((usage: any) => ({
      ...usage,
