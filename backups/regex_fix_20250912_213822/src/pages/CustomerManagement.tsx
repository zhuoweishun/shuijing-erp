    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {state.selected_customer && (
        <ReverseSaleModal
          ...
          on_close={() => setState(prev => ({ ...prev, show_reverse_sale_modal: false, selected_customer: null }))}
          on_success={handleReverseSaleSuccess}
        />
      )}
      ...
      {state.selected_customer && (
          <CustomerDetailModal
            ...
            on_close={() => setState(prev => ({ ...prev, show_detail_modal: false, selected_customer: null }))}
      ...
      {state.selected_customer && (
        <CustomerRefundModal
          ...
          on_close={() => setState(prev => ({ ...prev, show_refund_modal: false, selected_customer: null }))}
          on_success={handleReverseSaleSuccess}
        />
      )}
      ...
      <Customer_create_modal
        ...
        on_close={() => setState(prev => ({ ...prev, show_create_modal: false }))}
        on_success={handleCreateSuccess}
      />
