...
{
  "product_name": "水晶名称（如：白水晶、紫水晶、粉水晶等）",
  "material_type": "产品类型（LOOSE_BEADS/BRACELET/ACCESSORIES/FINISHED）",
...
- FINISHED（成品）：使用piece_count（件数）、unit_price（单价）
...
// 获取业务洞察
export const get_business_insights = async (query: string, options?: {
  timeRange?: string
