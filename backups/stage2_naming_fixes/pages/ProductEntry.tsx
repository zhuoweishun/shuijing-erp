                ...
                {formData.selected_materials.map((item: any) => {
                  ...
                  return(
                    <div key={material.purchase_id} className="flex justify-between text-xs">
                      ...
                      <span className="text-blue-700 font-medium">¥{itemCost.to_fixed(2)}</span>
                    </div>
                  )
                })}
                  ...
                  <div className="flex justify-between text-sm font-semibold">
                    ...
                    <span className="text-blue-900">
                      ¥{(() => {
                        ...
                        return singleMaterialCost.to_fixed(2)
                      })()}
                    </span>
                  </div>
                    ...
                    <div className="flex justify-between text-xs text-blue-700 mt-1">
                      ...
                      <span className="font-medium">
                        ¥{(() => {
                          ...
                          return totalMaterialCost.to_fixed(2)
                        })()}
                      </span>
                    </div>
                  )}
                  ...
                  {(formData.labor_cost > 0 || formData.craft_cost > 0 || formData.selling_price > 0) && (
                    <div className="border-t border-blue-300 pt-2 mt-2">
                      ...
                      <div className="flex justify-between text-xs text-blue-700">
                        <span>人工成本:</span>
                        <span>¥{((formData.labor_cost || 0) * formData.production_quantity).to_fixed(2)}</span>
                      </div>
                      
                      {/* 工艺成本 */}
                      <div className="flex justify-between text-xs text-blue-700">
                        <span>工艺成本:</span>
                        <span>¥{((formData.craft_cost || 0) * formData.production_quantity).to_fixed(2)}</span>
                      </div>
                      ...
                      {formData.selling_price > 0 && (() => {
                        ...
                        return(
                          <>
                            <div className="flex justify-between text-xs text-blue-700 mt-1">
                              <span>销售价格:</span>)
                              <span>¥{(formData.selling_price * formData.production_quantity).to_fixed(2)}</span>
                            </div>
               ...
               <div className="bg-gray-50 p-3 rounded-lg">
                 ...
                 <div className="space-y-1 text-sm">
                   ...
                   <div className="flex justify-between">
                     ...
                     <span>¥{(cost_calculation?.labor_cost || formData.labor_cost || 0).to_fixed(2)}</span>
                   </div>
                   
                   {/* 工艺成本 - 始终显示 */}
                   <div className="flex justify-between">
                     <span className="text-gray-600">工艺成本：</span>
                     <span>¥{(cost_calculation?.craft_cost || formData.craft_cost || 0).to_fixed(2)}</span>
                   </div>
                   
                   {/* 总成本计算 */}
                   {(() => {
                     const material_cost = cost_calculation?.materialCost || 0;
                     const labor_cost = cost_calculation?.laborCost || formData.labor_cost || 0;
                     const craft_cost = cost_calculation?.craftCost || formData.craft_cost || 0;
                     const total_cost = materialCost + laborCost + craftCost;
