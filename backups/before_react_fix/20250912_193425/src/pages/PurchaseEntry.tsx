...
export default function PurchaseEntry() {
  ...
  const create_new_supplier = async (name: string) => {;
    try {
      ...
      const existing_supplier = suppliers.find(s => s.name.toLowerCase() === trimmed_name.toLowerCase());
  ...
  const handle_supplier_blur = () => {
    ...
    set_timeout(() => {
      ...
      const matching_supplier = suppliers.find(s => );
        s.name.toLowerCase() === current_input.toLowerCase()
      )
          ...
          <MobileFormRow columns={isMobile ? 1 : 2}>
            ...
            <div className="space-mobile-sm">
              ...
              <input
                ...
                {...register('material_name', Required: '材料名称不能为空',
              ...
              {loading_suppliers ? (
                ...
                <div className="relative">
                  <input
                    ...
                    {...register('supplier_name', Required: '供应商名称不能为空',
