...
import SkuDestroyForm from './sku_destroy_form'
import SkuAdjustForm from './sku_adjust_form'
import SkuTraceView from './sku_trace_view'
import SkuHistoryView from './sku_history_view'
