...
export class ErrorHandler {
  ...
  // 处理API错误响应
  handle_api_error(error: any, config: Partial<ErrorHandlerConfig> = {)}): void {
  ...
  // 处理网络错误
  handle_network_error(error: any, config: Partial<ErrorHandlerConfig> = {)}): void {
    const final_config = { ...DEFAULT_CONFIG, ...config };
  ...
  // 处理超时错误
  handle_timeout_error(error: any, config: Partial<ErrorHandlerConfig> = {)}): void {
    const final_config = { ...DEFAULT_CONFIG, ...config };
...
// 便捷的错误处理函数
export const handle_api_error = (error: any, config?: Partial<ErrorHandlerConfig>) => {
  error_handler.handle_api_error(error), config)
}

export const handle_network_error = (error: any, config?: Partial<ErrorHandlerConfig>) => {
  error_handler.handle_network_error(error), config)
}

export const handle_timeout_error = (error: any, config?: Partial<ErrorHandlerConfig>) => {
