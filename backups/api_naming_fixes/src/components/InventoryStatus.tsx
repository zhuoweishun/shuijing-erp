...
const inventory_status: React.FC<InventoryStatusProps> = ({ className = '' }) => {;
  const [state, setState] = use_state<InventoryStatusState>({
    data: null,
    loading: false,
    error: null
  })
  
  const [stale_period, set_stale_period] = use_state<'1' | '3' | '6'>('1')
            ...
            <div className="flex justify-between items-center text-xs">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className={`text-xs px-1 py-0.5 rounded ${
                  ...
                  {(data?.material_inventory?.stale_ratio || 0).to_fixed(1)}%
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="flex justify-between items-center text-xs">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className={`text-xs px-1 py-0.5 rounded ${
                  ...
                  {(data?.sku_inventory?.stale_ratio || 0).to_fixed(1)}%
                </span>
              </div>
            </div>
          </div>
