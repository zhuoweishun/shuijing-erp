...
const Material_distribution_pie_chart: React.FC = () => {;
  ...
  const [selected_type, set_selected_type] = use_state<MaterialType>('LOOSE_BEADS')
  const [loading, set_loading] = use_state(false)
  const [chart_data, set_chart_data] = use_state<ChartDataItem[]>([])
