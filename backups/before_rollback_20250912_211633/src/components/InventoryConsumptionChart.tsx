...
interface ConsumptionItem {
  ...
  quality?: string
  supplier_name?: string, total_consumed: number, consumption_count: number, avg_consumption: number, last_consumption_date: string, first_consumption_date: string, unit_type: string // 单位类型：颗/件
}

interface ConsumptionData {
  time_range: string, total_consumption: number, total_consumption_count: number, top_consumed_products: ConsumptionItem[]
