...
interface InventoryStatistics {
  total_stats?: {
    total_items: number, total_quantity: number, total_low_stock: number
    total_value?: number
  },
  totalStats?: {
  ...
  type_statistics?: {
    product_type: string, total_items: number, total_quantity: number, low_stock_count: number
    total_value?: number
    avg_unit_price?: number
  }[]
  typeStatistics?: {
    productType: string, totalItems: number, totalQuantity: number
  ...
  low_stock_items: {
    ...
    quality?: string, remaining_quantity: number, min_stock_alert: number
    supplier_name?: string
  }[]
  quality_distribution: {
    quality: string, count: number, total_quantity: number
  }[]
  supplier_distribution: {
    supplier_name: string, total_items: number, total_quantity: number
    total_value?: number
  }[]
  price_distribution?: {
    price_range: string, count: number, avg_price: number
  }[]
}
