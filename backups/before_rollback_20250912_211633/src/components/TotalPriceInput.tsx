...
interface TotalPriceInputProps {
  label: string
  required?: boolean, value: number | string, onChange: (value: number | undefined) => void
  error?: string
  placeholder?: string
  // 动态显示相关的props, selectedProductType: string, unitPrice: number, totalBeads: number, pricePerBead: number, totalPrice: number
}
