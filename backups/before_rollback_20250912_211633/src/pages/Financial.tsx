...
interface FinancialState {
  overview: financial_overview | null, is_loading: boolean, error: string | null
},
const, Financial: React.FC = () => {
  const [state, set_state] = useState<FinancialState>({
    overview: null,
    is_loading: false,
    error: null
  ))
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="p-6">
          ...
          )}, {/* 统计图表标签页 */}, {active_tab === 'charts' && (
            <FinancialCharts />
          )}, {/* 流水账标签页 */}, {active_tab === 'transactions' && (
            <TransactionLog />
          )}
        </div>
      </div>
