...
export interface SkuPermissions {
  canViewPrice: boolean, canSell: boolean, canDestroy: boolean, canAdjust: boolean, canViewTrace: boolean, canViewHistory: boolean, canBatchOperate: boolean, canExport: boolean
}
