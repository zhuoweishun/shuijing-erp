...
* **后端**: Supabase (PostgreSQL + 实时API + 身份认证 + 文件存储)
...
VALUES 
('00000000-0000-0000-0000-000000000000', '紫水晶素珠', 15.00, 20.00, 300.00, '水晶批发商A'),
('00000000-0000-0000-0000-000000000000', '白水晶配饰', 8.00, 15.00, 120.00, '水晶批发商B');
```
...
VALUES 
('00000000-0000-0000-0000-000000000000', '紫水晶手串', '8mm紫水晶珠20颗', 50.00, 120.00, 70.00, false),
('00000000-0000-0000-0000-000000000000', '白水晶吊坠', '白水晶配饰+银链', 35.00, 88.00, 53.00, true);
```
