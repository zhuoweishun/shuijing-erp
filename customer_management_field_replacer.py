...
class CustomerFieldReplacer:
    def __init__(self):
        self.project_root = Path("d:/shuijing ERP")
        self.backup_dir = self.project_root / "backups" / f"customer_fields_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
        ...
        self.field_mappings = {
            ...
            'showDetailModal': 'show_detail_modal',
            'showReverseSaleModal': 'show_reverse_sale_modal',
            'showRefundModal': 'show_refund_modal',
            'columnFilters': 'column_filters',
            
            # 筛选查询字段
            'customerCodeSearch': 'customer_code_search',
            'nameSearch': 'name_search',
            'phoneSearch': 'phone_search',
            'cityFilter': 'city_filter',
            'totalOrdersMin': 'total_orders_min',
            'totalOrdersMax': 'total_orders_max',
            'totalAllOrdersMin': 'total_all_orders_min',
            'totalAllOrdersMax': 'total_all_orders_max',
            'totalPurchasesMin': 'total_purchases_min',
            'totalPurchasesMax': 'total_purchases_max',
            'firstPurchaseStart': 'first_purchase_start',
            'firstPurchaseEnd': 'first_purchase_end',
            'lastPurchaseStart': 'last_purchase_start',
            'lastPurchaseEnd': 'last_purchase_end',
            
            # 城市统计字段
            'cityStats': 'city_stats',
            'citySearchTerm': 'city_search_term',
            'filterPanelPosition': 'filter_panel_position'
        }
    ...
    def generate_report(self):
        ...
        # 保存报告
        report_file = self.project_root / f"customer_field_conversion_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
...
if __name__ == "__main__":
    replacer = CustomerFieldReplacer()
    replacer.run()